...
| :two: | [객체지향 프로그래밍 언어](#pencil2-객체지향-프로그래밍-언어-java) |
| :three: | [형상관리](#pencil2-형상관리) |
| `기출` | [Q1. JAVA와 C의 차이를 설명하시오.](#heavy_check_mark-q1-java와-c의-차이를-설명하시오)<br/>[Q2. JVM 가비지 컬렉션 동작 과정을 설명하시오.](#heavy_check_mark-q2-jvm-가비지-컬렉션-동작-과정을-설명하시오)<br/>[Q3. JAVA에 적용된 OOP에 대해서 설명하시오.](#heavy_check_mark-q3-java에-적용된-oop에-대해서-설명하시오)<br/>[Q4. 형상관리 활용 경험을 설명하시오.(C+Z/Y)](#heavy_check_mark-q4-형상관리-활용-경험을-설명하시오czy) |
